...
public:
    ...
    void generate_stats(float stats[4][3]);
    void get_stats();
    void display_stats();
    void get_averages(float averages[]);

    void move_carn();
    void move_herb();
    bool predator_spotting(int indice);
    bool detect_carnivore_partner(unsigned int indice, unsigned int *size);
    bool detect_herbivore_partner(unsigned int indice, unsigned int *size);
    ...
    void change_the_color(char color, int indice, char type);
    ...
    static const int base_min_vitesse_carn = 4;
    static const int base_max_vitesse_carn = 8;
    static const int base_min_vitesse_herb = 4;
    static const int base_max_vitesse_herb = 8;

    static const int base_min_height_carn = 25;
    static const int base_max_height_carn = 50;
    static const int base_min_height_herb = 25;
    static const int base_max_height_herb = 50;

    static const int range_herb_max = 4000;
    static const int range_carn_max = 4000;

    static const int base_min_range_carn = 400;
    static const int base_max_range_carn = 800;
    static const int base_min_range_herb = 400;
    static const int base_max_range_herb = 800;

    static const int herb_range_repro = 1000;
    static const int carn_range_repro = 1000;

    static const int base_min_starve_carn = 1000;
    static const int base_max_starve_carn = 2000;
    static const int base_min_starve_herb = 1000;
    static const int base_max_starve_herb = 2000;
...
private:
    ...
    int count_id_herb = 0;
    unsigned int indice_repro_carn;
    unsigned int indice_repro_herb;
    ...
    FILE* direct_data = fopen("data.txt", "w");
