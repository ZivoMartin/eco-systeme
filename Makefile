#############################################################################
# Makefile for building: eco-systeme
# Generated by qmake (3.1) (Qt 5.15.10)
# Project:  eco-systeme.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile eco-systeme.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = eco-systeme1.0.0
DISTDIR = /home/martin/Travail/Perso/eco-systeme/.tmp/eco-systeme1.0.0
LINK          = g++
...
SOURCES       = src/init.cpp \
		main.cpp \
		src/other/print.cpp \
		src/carn_functions/carn.cpp \
		src/elementary_functions/move_functions.cpp \
		src/carn_functions/move_carn.cpp \
		src/elementary_functions/get.cpp \
		src/elementary_functions/calcul_distance.cpp \
		src/elementary_functions/swaps.cpp \
		src/elementary_functions/add.cpp \
		src/herb_functions/herb.cpp \
		src/herb_functions/move_herb.cpp \
		src/herb_functions/plante_management.cpp \
		src/other/random.cpp \
		src/other/sort.cpp \
		src/other/change_color.cpp \
		src/carn_functions/corpse_management.cpp \
		src/other/stats.cpp moc_jeu.cpp
OBJECTS       = init.o \
		main.o \
		print.o \
		carn.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt/mkspecs/modules/qt_KWeatherCore.pri \
		...
		/usr/lib/qt/mkspecs/modules/qt_textaddonswidgets.pri \
		/usr/lib/qt/mkspecs/modules/qt_TextAutoCorrectionCore.pri \
		/usr/lib/qt/mkspecs/modules/qt_TextAutoCorrectionWidgets.pri \
		/usr/lib/qt/mkspecs/modules/qt_textcustomeditor.pri \
		/usr/lib/qt/mkspecs/modules/qt_TextEditTextToSpeech.pri \
		/usr/lib/qt/mkspecs/modules/qt_textemoticonscore.pri \
		/usr/lib/qt/mkspecs/modules/qt_textemoticonswidgets.pri \
		/usr/lib/qt/mkspecs/modules/qt_TextGrammarCheck.pri \
		/usr/lib/qt/mkspecs/modules/qt_TextTranslator.pri \
		/usr/lib/qt/mkspecs/modules/qt_textutils.pri \
		...
		eco-systeme.pro src/jeu.h \
		src/struct.h src/init.cpp \
		main.cpp \
		src/other/print.cpp \
		src/carn_functions/carn.cpp \
		src/elementary_functions/move_functions.cpp \
...
Makefile: eco-systeme.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		eco-systeme.pro
	$(QMAKE) -o Makefile eco-systeme.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/jeu.h src/struct.h $(DISTDIR)/
	$(COPY_FILE) --parents src/init.cpp main.cpp src/other/print.cpp src/carn_functions/carn.cpp src/elementary_functions/move_functions.cpp src/carn_functions/move_carn.cpp src/elementary_functions/get.cpp src/elementary_functions/calcul_distance.cpp src/elementary_functions/swaps.cpp src/elementary_functions/add.cpp src/herb_functions/herb.cpp src/herb_functions/move_herb.cpp src/herb_functions/plante_management.cpp src/other/random.cpp src/other/sort.cpp src/other/change_color.cpp src/carn_functions/corpse_management.cpp src/other/stats.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_jeu.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_jeu.cpp
moc_jeu.cpp: src/jeu.h \
		src/struct.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/martin/Travail/Perso/eco-systeme/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/martin/Travail/Perso/eco-systeme -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/13.2.1 -I/usr/include/c++/13.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/13.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/13.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/13.2.1/include-fixed -I/usr/include src/jeu.h -o moc_jeu.cpp
...
init.o: src/init.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o init.o src/init.cpp

main.o: main.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

print.o: src/other/print.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o print.o src/other/print.cpp

carn.o: src/carn_functions/carn.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o carn.o src/carn_functions/carn.cpp

move_functions.o: src/elementary_functions/move_functions.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o move_functions.o src/elementary_functions/move_functions.cpp

move_carn.o: src/carn_functions/move_carn.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o move_carn.o src/carn_functions/move_carn.cpp

get.o: src/elementary_functions/get.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o get.o src/elementary_functions/get.cpp

calcul_distance.o: src/elementary_functions/calcul_distance.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o calcul_distance.o src/elementary_functions/calcul_distance.cpp

swaps.o: src/elementary_functions/swaps.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o swaps.o src/elementary_functions/swaps.cpp

add.o: src/elementary_functions/add.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o add.o src/elementary_functions/add.cpp

herb.o: src/herb_functions/herb.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o herb.o src/herb_functions/herb.cpp

move_herb.o: src/herb_functions/move_herb.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o move_herb.o src/herb_functions/move_herb.cpp

plante_management.o: src/herb_functions/plante_management.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o plante_management.o src/herb_functions/plante_management.cpp

random.o: src/other/random.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o random.o src/other/random.cpp

sort.o: src/other/sort.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sort.o src/other/sort.cpp

change_color.o: src/other/change_color.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o change_color.o src/other/change_color.cpp

corpse_management.o: src/carn_functions/corpse_management.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o corpse_management.o src/carn_functions/corpse_management.cpp

stats.o: src/other/stats.cpp src/jeu.h \
		src/struct.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o stats.o src/other/stats.cpp
